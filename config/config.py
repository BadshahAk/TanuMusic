...
OWNER_USERNAME = getenv("OWNER_USERNAME", "Firdousi4321")

#❖  Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME", "DollxMusic_bot")

#❖  Don't Add style font 
BOT_NAME = getenv("BOT_NAME", "DollxMusic")

#❖ get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME", "Doll_Music_Line")
...
LOGGER_ID = int(getenv("LOGGER_ID", "-1002078667802"))

#❖ Get this value from @MissRose_bot on Telegram by /id
OWNER_ID = getenv("OWNER_ID", "5482856237")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/BadshahAk/TanuMusic",
)
